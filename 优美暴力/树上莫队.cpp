...
//树上莫队数据
int id1[2*maxn],num1[maxn],tot1,st[maxn],en[maxn];//树上莫队欧拉序与lca用的欧拉序有点不同
...
int n,m,u,v,a[maxn],b[maxn],block_size,block[2*maxn],have[max_color],used[max_color],ans[maxm],res;
struct query{
